...
public class UserController {
    ...
    public String registerUser(@RequestParam String username,
            ...
            @RequestParam String phoneNumber) { // Changed to phoneNumber
        User user = new User();
        user.setUsername(username);
        user.setPassword(password);
        user.setPhoneNumber(phoneNumber); // Changed to phoneNumber
        userService.registerUser(user);
        return "redirect:/api/users/login"; // Redirect to login after registration
    }
